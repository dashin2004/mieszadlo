"use strict";(self.webpackChunkwidgets=self.webpackChunkwidgets||[]).push([[7943],{27943:a=>{a.exports=`<div id="breaseKeyBoard" data-brease-widget="widgets/brease/KeyBoard" data-lang="nl">\r
\r
    ...
    <div class="keyBoardBody">\r
        ...
        <div class="keyBoardButtons">\r
            <div class="keyBoardRow">\r
                <button data-value="@" data-shift-value="\xA7" data-special-value="\xAC"></button>\r
                <button data-value="1" data-shift-value="!" data-special-value="\xB9"></button>\r
                ...
                <button data-value="4" data-shift-value="$" data-special-value="\xBC"></button>\r
                <button data-value="5" data-shift-value="%" data-special-value="\xBD"></button>\r
                <button data-value="6" data-shift-value="&" data-special-value="\xBE"></button>\r
                <button data-value="7" data-shift-value="_" data-special-value="\xA3"></button>\r
                ...
                <button data-value="\xB0" data-shift-value="~" data-special-value="\xB8"></button>\r
            ...
            <div class="keyBoardRow margin1">\r
                ...
                <button data-value="r" data-shift-value="R" data-special-value="\xB6"></button>\r
            ...
            <div class="keyBoardRow margin2">\r
                ...
                <button data-value="+" data-shift-value="\xB1" data-special-value=""></button>\r
                <button data-value="\xB4" data-shift-value="\`" data-special-value="\xB4"></button>\r
                <button data-value="&lt;" data-shift-value="&gt;" data-special-value=""><</button>\r
            ...
            <div class="keyBoardRow">\r
                ...
                <button data-value="z" data-shift-value="Z" data-special-value="\xAB"></button>\r
                <button data-value="x" data-shift-value="X" data-special-value="\xBB"></button>\r
                <button data-value="c" data-shift-value="C" data-special-value="\xA2"></button>\r
                ...
                <button data-value="," data-shift-value=";" data-special-value=""></button>\r
                <button data-value="." data-shift-value=":" data-special-value="\xB7"></button>\r
                <button data-value="-" data-shift-value="=" data-special-value=""></button>\r
