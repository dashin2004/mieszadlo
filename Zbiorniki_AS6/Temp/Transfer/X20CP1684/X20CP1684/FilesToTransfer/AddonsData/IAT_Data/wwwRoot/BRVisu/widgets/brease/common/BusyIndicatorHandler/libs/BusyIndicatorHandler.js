...
define([
    ...
    { config, core: { Class: SuperClass, Utils }, controller: { uiController } }
) {
    ...
    */
    ...
    p.dispose = function () {
        ...
        if (widget.busyWrapper) { 
            uiController.dispose(widget.busyWrapper, false); 
    ...
    p.showBusyIndicator = function () {
        if (config.editMode || this.widget.settings.busyIndicatorDelay < 0) { return; }
    ...
    p.createBusyIndicator = function (cssObject) {
        ...
        if (!widget.busyWrapper) {    
            ...
            uiController.createWidgets(widget.busyWrapper[0], [
                {
