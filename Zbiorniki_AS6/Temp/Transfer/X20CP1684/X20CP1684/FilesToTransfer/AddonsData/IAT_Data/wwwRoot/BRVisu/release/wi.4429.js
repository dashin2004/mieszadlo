"use strict";(self.webpackChunkwidgets=self.webpackChunkwidgets||[]).push([[4429],{34429:t=>{t.exports=`<div id="breaseTextKeyPad" class="breaseTextKeyPad hidden" data-brease-widget="widgets/brease/TextKeyPad" style="height:auto;z-index:0;" data-lang="it">\r
    <div>\r
        <div class="row">\r
            ...
            <button data-action="insertCharacter" class="cornerAlign"><span>\xA3</span><sup></sup><sub>3</sub></button>\r
            ...
            <button data-action="insertCharacter" class="cornerAlign"><span>?</span><sup></sup><sub>'</sub></button>\r
            <button data-action="insertCharacter" class="cornerAlign"><span>^</span><sup></sup><sub>\xEC</sub></button>\r
        ...
        <div class="row">\r
            <div class="col">\r
                <div class="row">\r
                    ...
                    <button data-action="insertCharacter"><span>O</span><sup>\xAB</sup><sub>o</sub></button>\r
                    <button data-key="P" data-action="insertCharacter" data-ctrl-action="jumptomatching"><span>P</span><sup>\xBB</sup><sub>p</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>\xE9</span><sup>[</sup><sub>\xE8</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>*</span><sup>]</sup><sub>+</sub></button>\r
                </div>\r
                <div class="row">\r
                    ...
                    <button data-action="insertCharacter" class="cornerAlign"><span>\xE7</span><sup>@</sup><sub>\xF2</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>\xB0</span><sup>#</sup><sub>\xE0</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>\xA7</span><sup></sup><sub>\xF9</sub></button>\r
                </div>\r
            </div>\r
            <div class="col">\r
        ...
        <div class="row">\r
            ...
            <div class="col">\r
                ...
                <div class="row">\r
                    <button data-key="switchLayout" data-action="switchLayout" class="doubleWidth"><span>it</span><sup></sup><sub></sub></button>\r
