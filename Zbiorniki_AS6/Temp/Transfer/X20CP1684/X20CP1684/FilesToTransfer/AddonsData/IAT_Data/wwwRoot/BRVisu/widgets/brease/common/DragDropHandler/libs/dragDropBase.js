...
function (Draggable, Droppable, Utils, EventListenerModel, DragDropArgs) {
    ...
    function _getDragDropArgs(self, event) {
        ...
        dragDropArgs.target = self._getDragDropTarget(event);
    ...
    function _dragEnter(self, event) {
        ...
        var target = self._getDragDropTarget(event);
    ...
    p._getDragDropTarget = function (event) {
    ...
    */
    p.getDraggableByElement = function (elem) {
        return this.draggables.get(elem);
    };
    ...
    */
    p.getDroppableByElement = function (elem) {
        return this.droppables.get(elem);
    };
    ...
    */
    p.registerDraggable = function (elem, settings) {
        ...
        this.draggables.set(elem, draggable);
    ...
    */
    p.registerDroppable = function (elem, settings) {
        ...
        this.droppables.set(elem, droppable);
    ...
    */
    p.unregisterDraggables = function () {
        this.draggables.forEach(value => {
            this.unregisterDraggable(value.elem);
        });
    ...
    */
    p.unregisterDroppables = function () {
        this.droppables.forEach(value => {
            this.unregisterDroppable(value.elem);
        });
