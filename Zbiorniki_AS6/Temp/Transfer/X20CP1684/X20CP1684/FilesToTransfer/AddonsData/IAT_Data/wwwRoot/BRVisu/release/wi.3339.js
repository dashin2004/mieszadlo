"use strict";(self.webpackChunkwidgets=self.webpackChunkwidgets||[]).push([[3339],{33339:a=>{a.exports=`<div id="breaseKeyBoard" data-brease-widget="widgets/brease/KeyBoard" data-lang="sk">\r
\r
    ...
    <div class="keyBoardBody">\r
        ...
        <div class="keyBoardButtons">\r
            <div class="keyBoardRow">\r
                <button data-value=";" data-shift-value="\xB0" data-special-value=""></button>\r
                <button data-value="+" data-shift-value="1" data-special-value="@"></button>\r
                <button data-value="\u013E" data-shift-value="2" data-special-value=""></button>\r
                <button data-value="\u0161" data-shift-value="3" data-special-value="^"></button>\r
                <button data-value="\u010D" data-shift-value="4" data-special-value="\u02D8"></button>\r
                <button data-value="\u0165" data-shift-value="5" data-special-value="\xB0"></button>\r
                <button data-value="\u017E" data-shift-value="6" data-special-value="\u02DB"></button>\r
                <button data-value="\xFD" data-shift-value="7" data-special-value="\`"></button>\r
                <button data-value="\xE1" data-shift-value="8" data-special-value="\u02D9"></button>\r
                <button data-value="\xED" data-shift-value="9" data-special-value="\xB4"></button>\r
                <button data-value="\xE9" data-shift-value="0" data-special-value="\u02DD"></button>\r
                <button data-value="=" data-shift-value="%" data-special-value="\xA8"></button>\r
                <button data-value="&apos;" data-shift-value="\u02C7" data-special-value="\xB8"></button>\r
                <button data-value="\u0148" data-shift-value=")" data-special-value="\xA4"></button>\r
            </div>\r
            <div class="keyBoardRow margin1">\r
                ...
                <button data-value="\xFA" data-shift-value="/" data-special-value="\xF7"></button>\r
                <button data-value="\xE4" data-shift-value="(" data-special-value="\xD7"></button>\r
            ...
            <div class="keyBoardRow margin2">\r
                ...
                <button data-value="s" data-shift-value="S" data-special-value="\u0111"></button>\r
                ...
                <button data-value="\xF4" data-shift-value="&quot;" data-special-value="$"></button>\r
                <button data-value="\xA7" data-shift-value="!" data-special-value="\xDF"></button>\r
            ...
            <div class="keyBoardRow">\r
                ...
                <button data-value="m" data-shift-value="M" data-special-value=""></button>\r
                <button data-value="," data-shift-value="?" data-special-value="&lt;"></button>\r
                <button data-value="." data-shift-value=":" data-special-value="&gt;"></button>\r
