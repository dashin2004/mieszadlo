define(['brease/enum/Enum', 'brease/core/Types', './external/dictionaries'],
    function (Enum, Types, Dictionaries) {

        /**
        * @class system.widgets.common.keyboards.Converter
        * Looks up composed values in a dictionary in order to 
