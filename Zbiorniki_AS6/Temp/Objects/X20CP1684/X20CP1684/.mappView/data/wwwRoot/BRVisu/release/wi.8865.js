"use strict";(self.webpackChunkwidgets=self.webpackChunkwidgets||[]).push([[8865],{18865:a=>{a.exports=`<div id="breaseKeyBoard" data-brease-widget="widgets/brease/KeyBoard" data-lang="fr" class="layoutIT">\r
\r
    ...
    <div class="keyBoardBody">\r
        ...
        <div class="keyBoardButtons">\r
            <div class="keyBoardRow">\r
                <button data-value="\xB2" data-shift-value="" data-special-value=""></button>\r
                <button data-value="&amp;" data-shift-value="1" data-special-value=""></button>\r
                <button data-value="\xE9" data-shift-value="2" data-special-value="~"></button>\r
                <button data-value="&quot;" data-shift-value="3" data-special-value="#"></button>\r
                <button data-value="&apos;" data-shift-value="4" data-special-value="{"></button>\r
                <button data-value="(" data-shift-value="5" data-special-value="["></button>\r
                <button data-value="-" data-shift-value="6" data-special-value="|"></button>\r
                <button data-value="\xE8" data-shift-value="7" data-special-value="\`"></button>\r
                <button data-value="_" data-shift-value="8" data-special-value="\\"></button>\r
                <button data-value="\xE7" data-shift-value="9" data-special-value="^"></button>\r
                <button data-value="\xE0" data-shift-value="0" data-special-value="@"></button>\r
                ...
                <button data-value="*" data-shift-value="\xB5" data-special-value=""></button>\r
            </div>\r
            <div class="keyBoardRow margin1">\r
                ...
                <button data-value="^" data-shift-value="\xA8" data-special-value=""></button>\r
                <button data-value="$" data-shift-value="*" data-special-value="\xA4"></button>\r
            ...
            <div class="keyBoardRow margin2">\r
                ...
                <button data-value="\xF9" data-shift-value="%" data-special-value=""></button>\r
