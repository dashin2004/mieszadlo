define([
    ...
    DragHandler.prototype.dispose = function () {
        ...
        DOM.bodyEl.off(BreaseEvent.MOUSE_MOVE, this.headerMoveHandler);
        DOM.bodyEl.off(BreaseEvent.MOUSE_UP, this.headerUpHandler);
        this.start = null;
    ...
    function _start(widget, e) {
        DOM.bodyEl.on(BreaseEvent.MOUSE_MOVE, this.headerMoveHandler);
        DOM.bodyEl.on(BreaseEvent.MOUSE_UP, this.headerUpHandler);
