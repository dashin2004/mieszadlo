"use strict";(self.webpackChunkwidgets=self.webpackChunkwidgets||[]).push([[2042],{12042:t=>{t.exports=`<div id="breaseTextKeyPad" class="breaseTextKeyPad hidden" data-brease-widget="widgets/brease/TextKeyPad" style="height:auto;z-index:0;" data-lang="lv">\r
    <div>\r
        <div class="row">\r
            ...
            <button data-action="insertCharacter" class="cornerAlign"><span>@</span><sup>\xAB</sup><sub>2</sub></button>\r
            <button data-action="insertCharacter" class="cornerAlign"><span>#</span><sup>\xBB</sup><sub>3</sub></button>\r
        ...
        <div class="row">\r
            <div class="col">\r
                <div class="row">\r
                    ...
                    <button data-action="insertCharacter"><span>E</span><sup>\u0113</sup><sub>e</sub></button>\r
                    <button data-action="insertCharacter"><span>R</span><sup>\u0157</sup><sub>r</sub></button>\r
                    ...
                    <button data-key="U" data-action="insertCharacter" data-ctrl-action="touppercase" data-ctrl-shift-action="tolowercase"><span>U</span><sup>\u016B</sup><sub>u</sub></button>\r
                    <button data-action="insertCharacter"><span>I</span><sup>\u012B</sup><sub>i</sub></button>\r
                ...
                <div class="row">\r
                    ...
                    <button data-key="A" data-action="insertCharacter" data-ctrl-action="selectall"><span>A</span><sup>\u0101</sup><sub>a</sub></button>\r
                    ...
                    <button data-action="insertCharacter"><span>G</span><sup>\u0123</sup><sub>g</sub></button>\r
                    ...
                    <button data-key="K" data-action="insertCharacter" data-ctrl-action="findnext" data-ctrl-shift-action="findprevious"><span>K</span><sup>\u0137</sup><sub>k</sub></button>\r
                    <button data-action="insertCharacter"><span>L</span><sup>\u013C</sup><sub>l</sub></button>\r
                    ...
                    <button data-action="insertCharacter" class="cornerAlign"><span>|</span><sup></sup><sub>\xB0</sub></button>\r
                </div>\r
            </div>\r
            <div class="col">\r
        ...
        <div class="row">\r
            ...
            <div class="col">\r
                <div class="row">\r
                    ...
                    <button data-action="insertCharacter"><span>N</span><sup>\u0146</sup><sub>n</sub></button>\r
                ...
                <div class="row">\r
                    <button data-key="switchLayout" data-action="switchLayout" class="doubleWidth"><span>lv</span><sup></sup><sub></sub></button>\r
