define([
...
], function (measurementSystem, languageService) {
    ...
    */
    UnitInfo.prototype.show = function (unitObj) {
        ...
        var currentMMS = measurementSystem.getCurrentMeasurementSystem(),
            unitCommonCode = unitObj ? unitObj[currentMMS] : undefined;

        languageService.pipeAsyncUnitSymbol(unitCommonCode, function (symbol) {
