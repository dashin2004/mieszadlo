define(['./KeyboardOptions',
    'brease/config' ], function (KeyboardOptions, breaseConfig) {

    'use strict';

    /**
     * @class system.widgets.common.keyboards.AutoSize
    ...
    var AutoSize = {
            ...
            /**
             * @method getOptions
             * get the options for a keyboardType, generated out of breaseConfig.virtualKeyboards
             * @param {system.widgets.common.keyboards.KeyboardType} type
             * @return {system.widgets.common.keyboards.KeyboardOptions}
             */
            getOptions: function (type) {
                if (!settings[type]) {
                    ...
                    if (breaseConfig && breaseConfig.virtualKeyboards) {
                        config = breaseConfig.virtualKeyboards[type];
                    }
             ...
             * @param {system.widgets.common.keyboards.KeyboardOptions} options
             * @return {Object} 
