define([
    ...
    * Example: {'horizontal': 'center', 'vertical': 105} 
    ...
    * E.g {pointOfOrigin:'container', position:{horizontal:'left'}} positions the window on the left side inside the element. {@img images/window_inside.png}
    * Value 'element' positions the window outside the reference element.   
    * E.g {pointOfOrigin:'element', position:{horizontal:'left'}} positions the window on the left side outside the element. {@img images/window_outside.png}
    * Value 'application' means the same positions as achieved with setting 'container' and element=document.body  
    */

    /**
    * @cfg {Object} arrow={'width':0, 'show':false, 'position': 'left'}
    ...
    * Has to be defined in descendants of Window in widget.settings. It's not necessary to define it in meta data.
    ...
    */
    return {
        html: 'system/widgets/Window/Window.html',
        modal: true,
        arrow: {
            show: false,
            width: 12,
