"use strict";(self.webpackChunkwidgets=self.webpackChunkwidgets||[]).push([[2384],{72384:a=>{a.exports=`<div id="breaseKeyBoard" data-brease-widget="widgets/brease/KeyBoard" data-lang="it" class="layoutIT">\r
\r
    ...
    <div class="keyBoardBody">\r
        ...
        <div class="keyBoardButtons">\r
            <div class="keyBoardRow">\r
                ...
                <button data-value="3" data-shift-value="\xA3" data-special-value=""></button>\r
                ...
                <button data-value="&apos;" data-shift-value="?" data-special-value=""></button>\r
                <button data-value="\xEC" data-shift-value="^" data-special-value=""></button>\r
                <button data-value="\xF9" data-shift-value="\xA7" data-special-value=""></button>\r
            </div>\r
            <div class="keyBoardRow margin1">\r
                ...
                <button data-value="o" data-shift-value="O" data-special-value="\xAB"></button>\r
                <button data-value="p" data-shift-value="P" data-special-value="\xBB"></button>\r
                <button data-value="\xE8" data-shift-value="\xE9" data-special-value="["></button>\r
                <button data-value="+" data-shift-value="*" data-special-value="]"></button>\r
            ...
            <div class="keyBoardRow margin2">\r
                ...
                <button data-value="\xF2" data-shift-value="\xE7" data-special-value="@"></button>\r
                <button data-value="\xE0" data-shift-value="\xB0" data-special-value="#"></button>\r
