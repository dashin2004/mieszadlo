define(['brease/events/BreaseEvent', 
    ...
    'brease/core/DOM',
    'brease/core/Utils'],
function (BreaseEvent, breaseConfig, DOM, Utils) {
    /**
        * @class system.widgets.common.keyboards.KeyCollector
    ...
    function KeyCollector() {
        ...
        self.init = function (eventDispatcher, widget) {
            ...
            self.clickEventName = _getEventConfig(breaseConfig.virtualKeyboards);
        ...
        self.onButtonMouseDown = function () {
            ...
            DOM.docEl.on(BreaseEvent.MOUSE_UP, self.onButtonMouseUp);
        };
        /**
        ...
        self.onButtonMouseUp = function () {
            DOM.docEl.off(BreaseEvent.MOUSE_UP, self.onButtonMouseUp);
            Utils.removeClass(self.activeButton, 'active');
        ...
        */
        ...
        self.onIMECandidateMouseDown = function () {
            ...
            DOM.docEl.on(BreaseEvent.MOUSE_UP, self.onIMECandidateMouseUp);
        ...
        self.onIMECandidateMouseUp = function (e) {
            ...
            DOM.docEl.off(BreaseEvent.MOUSE_UP, self.onIMECandidateMouseUp);
