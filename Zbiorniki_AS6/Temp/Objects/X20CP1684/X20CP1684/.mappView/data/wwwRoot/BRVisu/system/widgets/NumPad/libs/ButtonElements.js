define(['brease/events/EventDispatcher', 
    ...
    'brease/core/DOM',
    'brease/core/Utils'],
function (EventDispatcher, BreaseEvent, breaseConfig, DOM, Utils) {

    'use strict';

    /**
         * @class system.widgets.NumPad.libs.ButtonElements
         * @extends core.javascript.Object
         * Wraps browser websocket for use in mapp View context.
         */
    ...
    ButtonElements.prototype.init = function () {
        ...
        this.clickEventName = _getEventConfig(breaseConfig.virtualKeyboards);
    };
    ...
    ButtonElements.prototype.removeListeners = function () {
        ...
        DOM.docEl.off(BreaseEvent.MOUSE_UP, this.buttonUpHandler);
    };
    ...
    ButtonElements.prototype.buttonDownHandler = function (e) {
        ...
        DOM.docEl.on(BreaseEvent.MOUSE_UP, this.buttonUpHandler);
    };
