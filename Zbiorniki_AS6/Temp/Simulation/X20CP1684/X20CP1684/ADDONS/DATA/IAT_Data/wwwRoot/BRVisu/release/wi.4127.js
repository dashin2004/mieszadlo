"use strict";(self.webpackChunkwidgets=self.webpackChunkwidgets||[]).push([[4127],{64127:t=>{t.exports=`<div id="breaseTextKeyPad" class="breaseTextKeyPad hidden" data-brease-widget="widgets/brease/TextKeyPad" style="height:auto;z-index:0;" data-lang="he">\r
    <div>\r
        <div class="row">\r
            ...
            <button data-action="insertCharacter" class="cornerAlign"><span>_</span><sup>\u05BF</sup><sub>-</sub></button>\r
            <button data-action="insertCharacter" class="cornerAlign"><span>+</span><sup></sup><sub>=</sub></button>\r
        ...
        <div class="row">\r
            <div class="col">\r
                <div class="row">\r
                    ...
                    <button data-action="insertCharacter"><span>Q</span><sup></sup><sub>/</sub></button>\r
                    <button data-action="insertCharacter"><span>W</span><sup></sup><sub>'</sub></button>\r
                    <button data-action="insertCharacter"><span>E</span><sup>\u20AC</sup><sub>\u05E7</sub></button>\r
                    <button data-action="insertCharacter"><span>R</span><sup></sup><sub>\u05E8</sub></button>\r
                    <button data-action="insertCharacter"><span>T</span><sup></sup><sub>\u05D0</sub></button>\r
                    <button data-key="Y" data-action="insertCharacter" data-ctrl-action="redo"><span>Y</span><sup></sup><sub>\u05D8</sub></button>\r
                    <button data-key="U" data-action="insertCharacter" data-ctrl-action="touppercase" data-ctrl-shift-action="tolowercase"><span>U</span><sup>\u05F0</sup><sub>\u05D5</sub></button>\r
                    <button data-action="insertCharacter"><span>I</span><sup></sup><sub>\u05DF</sub></button>\r
                    <button data-action="insertCharacter"><span>O</span><sup></sup><sub>\u05DD</sub></button>\r
                    <button data-key="P" data-action="insertCharacter" data-ctrl-action="jumptomatching"><span>P</span><sup></sup><sub>\u05E4</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>}</span><sup></sup><sub>]</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>{</span><sup></sup><sub>[</sub></button>\r
                </div>\r
                <div class="row">\r
                    <button data-key="Caps" data-action="capslock" class="doubleWidth">Caps<sub></sub><sup></sup></button>\r
                    <button data-key="A" data-action="insertCharacter" data-ctrl-action="selectall"><span>A</span><sup></sup><sub>\u05E9</sub></button>\r
                    <button data-action="insertCharacter"><span>S</span><sup></sup><sub>\u05D3</sub></button>\r
                    <button data-key="D" data-action="insertCharacter" data-ctrl-action="removeline" data-ctrl-shift-action="duplicateSelection"><span>D</span><sup></sup><sub>\u05D2</sub></button>\r
                    <button data-key="F" data-action="insertCharacter" data-ctrl-action="find" data-ctrl-shift-action="findprevious"><span>F</span><sup></sup><sub>\u05DB</sub></button>\r
                    <button data-action="insertCharacter"><span>G</span><sup></sup><sub>\u05E2</sub></button>\r
                    <button data-key="H" data-action="insertCharacter" data-ctrl-action="replace"><span>H</span><sup>\u05F2</sup><sub>\u05D9</sub></button>\r
                    <button data-action="insertCharacter"><span>J</span><sup>\u05F1</sup><sub>\u05D7</sub></button>\r
                    <button data-key="K" data-action="insertCharacter" data-ctrl-action="findnext" data-ctrl-shift-action="findprevious"><span>K</span><sup></sup><sub>\u05DC</sub></button>\r
                    <button data-action="insertCharacter"><span>L</span><sup></sup><sub>\u05DA</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>|</span><sup></sup><sub>\\</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>'</span><sup></sup><sub>,</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>|</span><sup></sup><sub>\\</sub></button>\r
                </div>\r
        ...
        <div class="row">\r
            ...
            <div class="col">\r
                <div class="row">\r
                    <button data-key="Z" data-action="insertCharacter" data-ctrl-action="undo"><span>Z</span><sup></sup><sub>\u05D6</sub></button>\r
                    <button data-key="X" data-action="insertCharacter" data-ctrl-action="vCut"><span>X</span><sup></sup><sub>\u05E1</sub></button>\r
                </div>\r
                <div class="row">\r
            ...
            <div class="col">\r
                <div class="row">\r
                    <button data-key="C" data-action="insertCharacter" data-ctrl-action="vCopy"><span>C</span><sup></sup><sub>\u05D1</sub></button>\r
                    <button data-key="V" data-action="insertCharacter" data-ctrl-action="vPaste"><span>V</span><sup></sup><sub>\u05D4</sub></button>\r
                    <button data-action="insertCharacter"><span>B</span><sup></sup><sub>\u05E0</sub></button>\r
                    <button data-action="insertCharacter"><span>N</span><sup></sup><sub>\u05DE</sub></button>\r
                    <button data-action="insertCharacter"><span>M</span><sup></sup><sub>\u05E6</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>&gt;</span><sup></sup><sub>\u05EA</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>&lt;</span><sup></sup><sub>\u05E5</sub></button>\r
                    <button data-action="insertCharacter" class="cornerAlign"><span>?</span><sup>\xBF</sup><sub>.</sub></button>\r
                </div>\r
                <div class="row">\r
                    <button data-key="switchLayout" data-action="switchLayout" class="doubleWidth"><span>he</span><sup></sup><sub></sub></button>\r
